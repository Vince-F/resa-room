...
export class ReservationDataSource extends DataSource<any> {
    connect(): Observable<Reservation[]> {
        let testData:Array<Reservation[]> = [
            ...
            [{_id:"456554",roomId:"634",authorId:"test",beginDate:new Date("2017-08-11T08:00:00.000Z"),endDate:new Date("2017-08-11T12:00:00.000Z"),comment:"ffdfd"},{_id:"46565",roomId:"6534",authorId:"admin",beginDate:new Date("2017-08-11T13:00:00.000Z"),endDate:new Date("2017-08-11T20:00:00.000Z"),comment:"jiijij"}] // set 2
        ];
